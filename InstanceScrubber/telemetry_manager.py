...
class TelemetryManager:  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, config: Any, *, metrics_dir: Optional[Path] = None) -> None:  # noqa: ANN401 – config is duck-typed
        ...
        class _FileMetricExporter(MetricExporter):
            ...
            def export(self, metrics_data, timeout_millis: int = 30_000, **kwargs) -> "MetricExportResult":  # type: ignore[override]
                try:
            ...
            def shutdown(self, timeout_millis: int = 30_000, **kwargs):  # noqa: D401 – override
                # Accept both timeout_millis and timeout for compatibility
                return MetricExportResult.SUCCESS
        ...
        if metrics_dir is None:
            ...
            metrics_dir = Path(metrics_dir)  # Ensure it's a Path object
        ...
        # Store provider and shutdown callback so callers can flush & close on exit.
    ...
    # ..................................................................
    def force_flush(self) -> None:  # noqa: D401 – imperative API
        ...
        try:
            ...
            logger.debug("Telemetry force_flush failed: %s", exc)
